...
const Profile = ({
    getProfileById,
    profile: {profileById, loading}, authDoctor,authUser, params
}) => {
    const {id}=params;
    useEffect(() => {
                            ...
                            <div className="container">
                                <div className="current-profile">
                                    <div className="current-btn">
                                        <Link className="rounded-pill btn btn-dark" to="/profiles">Back to Profiles</Link>
                                    ...
                                    <div className="patient-review">
                                            ...
                                            }
                                            {
                                                profileById.review.map(rev => (
                                                    <ProfileReview key={rev._id} review={rev} doctorId={id} />
                                                ))
                                            }
                                        </div>
                                </div>
